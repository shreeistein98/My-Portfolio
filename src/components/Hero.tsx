  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16 pb-16">
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Image - Changed from circular to rectangular frame */}
        <div className="relative flex justify-center items-center animate-fade-in-right">
          <div className="relative w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[28rem] lg:w-[28rem] lg:h-[32rem] overflow-hidden rounded-xl border-4 border-white dark:border-gray-800 shadow-xl">
            <img
